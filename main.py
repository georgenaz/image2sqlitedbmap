...
from map_calc_tools import calculate_optimal_z, get_tile_coords, get_tile_center_gps, find_pixel_coords
...
def main():
    ...
    pixel_coords = find_pixel_coords(image_width, image_height, image_corners, target_gps)
